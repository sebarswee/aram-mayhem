...
import { RockSpikeEffectPool, RockSpikeEffectConfig } from '@/pools/effects/RockSpikeEffectPool';
...
describe('RockSpikeEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: RockSpikeEffectConfig = {
        x: 100,
        y: 100,
        trapRadius: 50,
        duration: 3000,
