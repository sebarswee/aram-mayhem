...
import { WaterDashEffectPool, WaterDashEffectConfig } from '@/pools/effects/WaterDashEffectPool';
...
describe('WaterDashEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: WaterDashEffectConfig = {
        x: 100,
        y: 100,
        dashDistance: 200,
        trailWidth: 40,
