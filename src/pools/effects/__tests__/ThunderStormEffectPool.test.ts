...
import { ThunderStormEffectPool, ThunderStormEffectConfig } from '@/pools/effects/ThunderStormEffectPool';
...
describe('ThunderStormEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: ThunderStormEffectConfig = {
        x: 100,
        y: 100,
        range: 150,
        strikeCount: 3,
