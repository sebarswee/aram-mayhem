...
import { ArcLightningEffectPool, ArcLightningEffectConfig } from '@/pools/effects/ArcLightningEffectPool';
...
describe('ArcLightningEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: ArcLightningEffectConfig = {
        x: 100,
        y: 100,
        range: 150,
        pulseWidth: 50,
