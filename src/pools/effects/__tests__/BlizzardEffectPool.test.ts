...
import { BlizzardEffectPool, BlizzardEffectConfig } from '@/pools/effects/BlizzardEffectPool';
...
describe('BlizzardEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: BlizzardEffectConfig = {
        x: 100,
        y: 100,
        radius: 150,
        duration: 3000,
        tickInterval: 500,
        layerConfigs: [
          { radius: 165, color: 0x66ccff, alpha: 0.12 },
          { radius: 150, color: 0x88ddff, alpha: 0.18 },
          { radius: 127, color: 0xaaeeff, alpha: 0.15 },
        ],
      };
  ...
  describe('粒子系统管理', () => {
    it('应该创建霜冻和雪花粒子发射器', () => {
      const config: BlizzardEffectConfig = {
        ...
        duration: 3000,
        tickInterval: 500,
        layerConfigs: [{ radius: 165, color: 0x66ccff, alpha: 0.12 }],
      };
