...
import { EarthGuardianEffectPool, EarthGuardianEffectConfig } from '@/pools/effects/EarthGuardianEffectPool';
...
describe('EarthGuardianEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: EarthGuardianEffectConfig = {
        x: 100,
        y: 100,
        duration: 6000,
      };
