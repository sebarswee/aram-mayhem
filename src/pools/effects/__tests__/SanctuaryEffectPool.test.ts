...
import { SanctuaryEffectPool, SanctuaryEffectConfig } from '@/pools/effects/SanctuaryEffectPool';
...
function createMockCircle(name: string) {
  return {
    ...
    scaleY: 1,
    alpha: 1,
    strokeStyle: { width: 0, color: 0, alpha: 0 },
    setRadius: vi.fn(function(this: any, r: number) { this.radius = r; return this; }),
    setFillStyle: vi.fn(function(this: any) { return this; }),
    setStrokeStyle: vi.fn(function(this: any, w: number, c: number, a: number) {
      this.strokeStyle = { width: w, color: c, alpha: a };
      return this;
    }),
...
describe('SanctuaryEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: SanctuaryEffectConfig = {
        x: 100,
        y: 100,
        radius: 200,
        duration: 5000,
  ...
  describe('自定义配置', () => {
    it('应该支持自定义圣域图层配置', () => {
      const config: SanctuaryEffectConfig = {
        ...
        layerConfigs: [
          ...
          { radius: 0.8, color: 0x0000ff, alpha: 0.15 },
          { radius: 0.5, color: 0xffff00, alpha: 0.1 },
        ],
      };
    ...
    it('应该支持自定义旋转光环配置', () => {
      const config: SanctuaryEffectConfig = {
        ...
        duration: 5000,
        ringConfigs: [
          { lineWidth: 3, color: 0xffffff, alpha: 0.5, radiusMultiplier: 0.3, rotationDuration: 1500 },
          { lineWidth: 2, color: 0xffff00, alpha: 0.4, radiusMultiplier: 0.6, rotationDuration: 2000 },
          { lineWidth: 1, color: 0xffcc00, alpha: 0.3, radiusMultiplier: 0.9, rotationDuration: 2500 },
        ],
      };
