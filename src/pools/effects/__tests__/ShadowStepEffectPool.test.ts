...
import { ShadowStepEffectPool, ShadowStepEffectConfig } from '@/pools/effects/ShadowStepEffectPool';
...
describe('ShadowStepEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: ShadowStepEffectConfig = {
        x: 100,
        y: 100,
        duration: 3000,
      };
  ...
  describe('无限 Tween 管理', () => {
    it('应该创建无限循环的脉动 tween', () => {
