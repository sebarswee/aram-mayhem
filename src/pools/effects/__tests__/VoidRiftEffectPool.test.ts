...
import { VoidRiftEffectPool, VoidRiftEffectConfig } from '@/pools/effects/VoidRiftEffectPool';
...
describe('VoidRiftEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: VoidRiftEffectConfig = {
        x: 100,
        y: 100,
        radius: 200,
        duration: 3000,
  ...
  describe('自定义配置', () => {
    it('应该支持自定义裂隙核心配置', () => {
      const config: VoidRiftEffectConfig = {
        ...
        riftConfigs: [
          ...
          { radius: 40, color: 0x00ff00, alpha: 0.6 },
          { radius: 20, color: 0x0000ff, alpha: 0.7 },
        ],
      };
    ...
    it('应该支持自定义虚空环配置', () => {
      const config: VoidRiftEffectConfig = {
        ...
        duration: 3000,
        ringConfigs: [
          { lineWidth: 5, color: 0xff0000, alpha: 0.5, radiusMultiplier: 0.2, rotationDuration: 500, direction: 1 },
          { lineWidth: 4, color: 0x00ff00, alpha: 0.4, radiusMultiplier: 0.4, rotationDuration: 700, direction: -1 },
          { lineWidth: 3, color: 0x0000ff, alpha: 0.3, radiusMultiplier: 0.6, rotationDuration: 900, direction: 1 },
          { lineWidth: 2, color: 0xffff00, alpha: 0.2, radiusMultiplier: 0.8, rotationDuration: 1100, direction: -1 },
          { lineWidth: 1, color: 0xff00ff, alpha: 0.1, radiusMultiplier: 1.0, rotationDuration: 1300, direction: 1 },
        ],
      };
