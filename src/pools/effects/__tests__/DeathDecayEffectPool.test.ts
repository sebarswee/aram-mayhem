...
import { DeathDecayEffectPool, DeathDecayEffectConfig } from '@/pools/effects/DeathDecayEffectPool';
...
describe('DeathDecayEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: DeathDecayEffectConfig = {
        x: 100,
        y: 100,
        radius: 200,
        duration: 5000,
  ...
  describe('自定义配置', () => {
    it('应该支持自定义凋零图层配置', () => {
      const config: DeathDecayEffectConfig = {
        ...
        duration: 5000,
        layerConfigs: [
          { radius: 1.2, color: 0x110011, alpha: 0.15 },
          { radius: 1.0, color: 0x330033, alpha: 0.30 },
          { radius: 0.8, color: 0x550055, alpha: 0.25 },
          { radius: 0.6, color: 0x770077, alpha: 0.20 },
        ],
      };
    ...
    it('应该支持自定义粒子配置', () => {
      const config: DeathDecayEffectConfig = {
        ...
        particleConfig: {
          ...
          frequency: 80,
          quantity: 3,
          colors: [0x770077, 0x990099, 0xbb00bb],
        },
      };
  ...
  describe('复用功能', () => {
    it('对象应该能被复用', () => {
      const config1: DeathDecayEffectConfig = {
        x: 100,
        y: 100,
        radius: 200,
        duration: 5000,
      ...
      const config2: DeathDecayEffectConfig = {
        x: 200,
        y: 200,
        radius: 300,
        duration: 4000,
