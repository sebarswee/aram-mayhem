...
import { FlameWaveEffectPool, FlameWaveEffectConfig } from '@/pools/effects/FlameWaveEffectPool';
...
describe('FlameWaveEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: FlameWaveEffectConfig = {
        x: 100,
        y: 100,
        range: 150,
        coneAngle: 1.2,
