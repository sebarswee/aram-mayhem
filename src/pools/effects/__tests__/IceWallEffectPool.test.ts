...
import { IceWallEffectPool, IceWallEffectConfig } from '@/pools/effects/IceWallEffectPool';
...
describe('IceWallEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: IceWallEffectConfig = {
        x: 100,
        y: 100,
        wallWidth: 80,
        wallHeight: 120,
