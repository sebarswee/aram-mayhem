...
import { ElectricFieldEffectPool, ElectricFieldEffectConfig } from '@/pools/effects/ElectricFieldEffectPool';
import Phaser from 'phaser';
import './setupPhaserGeom';
...
describe('ElectricFieldEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: ElectricFieldEffectConfig = {
        x: 100,
        y: 100,
        range: 150,
        duration: 3000,
        tickInterval: 500,
        layerConfigs: [
          { radius: 150, color: 0xffff00, alpha: 0.15 },
          { radius: 127, color: 0xffff00, alpha: 0.2 },
          { radius: 105, color: 0xffffff, alpha: 0.1 },
        ],
        pulseRingConfigs: [
          { radius: 45 },
          { radius: 75 },
  ...
  describe('释放时清理', () => {
    it('release 应该正确停用对象', () => {
      const config: ElectricFieldEffectConfig = {
        ...
        duration: 3000,
        tickInterval: 500,
        layerConfigs: [{ radius: 150, color: 0xffff00, alpha: 0.15 }],
        pulseRingConfigs: [{ radius: 45 }],
      };
