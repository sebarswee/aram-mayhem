...
import { HolyLightEffectPool, HolyLightEffectConfig } from '@/pools/effects/HolyLightEffectPool';
...
describe('HolyLightEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: HolyLightEffectConfig = {
        x: 100,
        y: 100,
        range: 150,
        duration: 700,
