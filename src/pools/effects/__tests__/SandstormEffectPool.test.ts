...
import { SandstormEffectPool, SandstormEffectConfig } from '@/pools/effects/SandstormEffectPool';
...
describe('SandstormEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: SandstormEffectConfig = {
        x: 100,
        y: 100,
        radius: 150,
        duration: 3000,
        tickInterval: 500,
        layerConfigs: [
          { radius: 165, color: 0x886633, alpha: 0.35 },
          { radius: 150, color: 0x997744, alpha: 0.4 },
        ],
      };
