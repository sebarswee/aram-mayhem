...
import { FrostNovaEffectPool, FrostNovaEffectConfig } from '@/pools/effects/FrostNovaEffectPool';
...
describe('FrostNovaEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: FrostNovaEffectConfig = {
        x: 100,
        y: 100,
        range: 150,
        crystalCount: 8,
