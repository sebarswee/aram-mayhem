...
import { BlackHoleEffectPool, BlackHoleEffectConfig } from '@/pools/effects/BlackHoleEffectPool';
...
describe('BlackHoleEffectPool', () => {
  ...
  describe('基础功能', () => {
    ...
    it('应该能获取和释放对象', () => {
      const config: BlackHoleEffectConfig = {
        x: 100,
        y: 100,
        radius: 200,
        duration: 2000,
  ...
  describe('自定义配置', () => {
    it('应该支持自定义黑洞核心配置', () => {
      const config: BlackHoleEffectConfig = {
        ...
        duration: 2000,
        coreConfigs: [
          { radius: 60, color: 0xff0000, alpha: 0.5 },
          { radius: 45, color: 0x00ff00, alpha: 0.6 },
          { radius: 30, color: 0x0000ff, alpha: 0.7 },
        ],
      };
    ...
    it('应该支持自定义引力环配置', () => {
      const config: BlackHoleEffectConfig = {
        ...
        duration: 2000,
        ringConfigs: [
          { lineWidth: 5, color: 0xff0000, alpha: 0.4, radiusMultiplier: 0.2, rotationDuration: 500, direction: 1 },
          { lineWidth: 4, color: 0x00ff00, alpha: 0.3, radiusMultiplier: 0.4, rotationDuration: 600, direction: -1 },
          { lineWidth: 3, color: 0x0000ff, alpha: 0.2, radiusMultiplier: 0.6, rotationDuration: 700, direction: 1 },
          { lineWidth: 2, color: 0xffff00, alpha: 0.15, radiusMultiplier: 0.8, rotationDuration: 800, direction: -1 },
          { lineWidth: 1.5, color: 0xff00ff, alpha: 0.1, radiusMultiplier: 1.0, rotationDuration: 900, direction: 1 },
          { lineWidth: 1, color: 0x00ffff, alpha: 0.05, radiusMultiplier: 1.2, rotationDuration: 1000, direction: -1 },
        ],
      };
